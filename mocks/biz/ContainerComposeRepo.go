...
// Create provides a mock function with given fields: name, compose
func (_m *ContainerComposeRepo) Create(name string, compose string) error {
	ret := _m.Called(name, compose)
...
//   - name string
//   - compose string
func (_e *ContainerComposeRepo_Expecter) Create(name interface{}, compose interface{}) *ContainerComposeRepo_Create_Call {
	return &ContainerComposeRepo_Create_Call{Call: _e.mock.On("Create", name, compose)}
}

func (_c *ContainerComposeRepo_Create_Call) Run(run func(name string, compose string)) *ContainerComposeRepo_Create_Call {
...
func (_c *ContainerComposeRepo_Create_Call) RunAndReturn(run func(string, string) error) *ContainerComposeRepo_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ContainerComposeRepo) Get(name string) (string, error) {
	ret := _m.Called(name)
...
func (_c *ContainerComposeRepo_Get_Call) Return(_a0 string, _a1 error) *ContainerComposeRepo_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ContainerComposeRepo_Get_Call) RunAndReturn(run func(string) (string, error)) *ContainerComposeRepo_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with no fields
func (_m *ContainerComposeRepo) List() ([]string, error) {
	ret := _m.Called()
...
func (_c *ContainerComposeRepo_List_Call) Return(_a0 []string, _a1 error) *ContainerComposeRepo_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ContainerComposeRepo_List_Call) RunAndReturn(run func() ([]string, error)) *ContainerComposeRepo_List_Call {
	_c.Call.Return(run)
	return _c
}
