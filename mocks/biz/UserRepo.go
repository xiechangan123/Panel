...
func (_m *UserRepo) Count() (int64, error) {
	ret := _m.Called()
...
func (_c *UserRepo_Count_Call) Return(_a0 int64, _a1 error) *UserRepo_Count_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *UserRepo) Delete(id uint) (string, error) {
	ret := _m.Called(id)
...
func (_c *UserRepo_Delete_Call) Return(_a0 string, _a1 error) *UserRepo_Delete_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepo_Delete_Call) RunAndReturn(run func(uint) (string, error)) *UserRepo_Delete_Call {
	_c.Call.Return(run)
	return _c
}
